...
boost::optional<double> WeatherDataPoint::toDouble(WeatherDataFieldId id)
{
  ...
  case RelativeHumidity:
    value = relativeHumidity();
    break;
  case AtmosphericStationPressure:
    value = atmosphericStationPressure();
    break;
  case ExtraterrestrialHorizontalRadiation:
    value = extraterrestrialHorizontalRadiation();
    break;
  case ExtraterrestrialDirectNormalRadiation:
    value = extraterrestrialDirectNormalRadiation();
    break;
  case HorizontalInfraredRadiationIntensity:
    value = horizontalInfraredRadiationIntensity();
    break;
  case GlobalHorizontalRadiation:
    value = globalHorizontalRadiation();
    break;
  case DirectNormalRadiation:
    value = directNormalRadiation();
    break;
  case DiffuseHorizontalRadiation:
    value = diffuseHorizontalRadiation();
    break;
  case GlobalHorizontalIlluminance:
    value = globalHorizontalIlluminance();
    break;
  case DirectNormalIlluminance:
    value = directNormalIlluminance();
    break;
  case DiffuseHorizontalIlluminance:
    value = diffuseHorizontalIlluminance();
    break;
  case ZenithLuminance:
  ...
  case CeilingHeight:
    value = ceilingHeight();
    break;
  case PresentWeatherObservation:
    value = m_presentWeatherObservation;
    break;
  case PresentWeatherCodes:
    value = m_presentWeatherCodes;
    break;
  case PrecipitableWater:
    value = precipitableWater();
    break;
  ...
  case SnowDepth:
    value = snowDepth();
    break;
  case DaysSinceLastSnowfall:
    value = daysSinceLastSnowfall();
    break;
  case Albedo:
    value = albedo();
    break;
  case LiquidPrecipitationDepth:
    value = liquidPrecipitationDepth();
    break;
  case LiquidPrecipitationQuantity:
    value = liquidPrecipitationQuantity();
    break;
  default:
    return boost::none;
  }
